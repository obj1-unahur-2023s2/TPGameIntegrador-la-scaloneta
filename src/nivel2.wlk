...
const nivel2 = new Nivel(
	...
	ladrillos = [
		new Ladrillo(position = game.at(2,3)),
		new Ladrillo(position = game.at(2,5)),
		new Ladrillo(position = game.at(2,7)),
		new Ladrillo(position = game.at(2,9)),
		new Ladrillo(position = game.at(2,11)),
		new Ladrillo(position = game.at(2,13)),
		new Ladrillo(position = game.at(2,15)),
		new Ladrillo(position = game.at(2,17)),
		new Ladrillo(position = game.at(2,19)),
		
		new Ladrillo(position = game.at(4,4)),
		new Ladrillo(position = game.at(4,8)),
		new Ladrillo(position = game.at(4,12)),
		new Ladrillo(position = game.at(4,15)),
		
		
		new Ladrillo(position = game.at(7,4)),
		new Ladrillo(position = game.at(7,8)),
		new Ladrillo(position = game.at(7,12)),
		new Ladrillo(position = game.at(7,15)),
			
		
		new Ladrillo(position = game.at(10,3)),
		new Ladrillo(position = game.at(10,6)),
		new Ladrillo(position = game.at(10,9)),
		
		new Ladrillo(position = game.at(16,2)),
		new Ladrillo(position = game.at(16,4)),
		new Ladrillo(position = game.at(16,6)),
		new Ladrillo(position = game.at(16,8)),
		new Ladrillo(position = game.at(16,10)),
		new Ladrillo(position = game.at(16,12)),
		new Ladrillo(position = game.at(16,14)),
		new Ladrillo(position = game.at(16,16)),
		new Ladrillo(position = game.at(16,18))
	],
	posInicial = game.at(19,2),
	posDeBase = game.at(10,19)
	)